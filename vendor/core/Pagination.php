...
class Pagination
{
    ...
    public function getHtml()
    {
        $back = null; // GERI
        $forward = null; // IRELI
        $startpage = null; // EVVEL
        $endpage = null; // SON
        $page2left = null; // soldan ikinci səhifə
        $page1left = null; // soldan birinci səhifə
        $page2right = null; // sagdan ikinci səhifə
        $page1right = null; // sagdan birinci səhifə
